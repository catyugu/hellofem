"""Case-pipeline pytest: runs the full COMSOL -> clean -> solve -> compare
pipeline for the EcTSmBarStationary case and asserts the comparison passes.

Requires COMSOL on PATH (comsolcompile/comsolbatch) and a built mpfem_app;
skips otherwise. This is the app-layer result verification (pytest-only).
"""
