...
using namespace hellofem::basis;
...
template <std::floating_point T>
FiniteElement<T>
hellofem::basis::create_element(element::family family, cell::type cell, int degree,
...
//-----------------------------------------------------------------------------
template hellofem::basis::FiniteElement<float>
hellofem::basis::create_element(element::family, cell::type, int,
    element::lagrange_variant, element::dpc_variant, bool,
    std::vector<int>);
template hellofem::basis::FiniteElement<double>
hellofem::basis::create_element(element::family, cell::type, int,
    element::lagrange_variant, element::dpc_variant, bool,
    std::vector<int>);
//-----------------------------------------------------------------------------
template <std::floating_point T>
FiniteElement<T>
hellofem::basis::create_tp_element(element::family family, cell::type cell, int degree,
    element::lagrange_variant lvariant,
    element::dpc_variant dvariant, bool discontinuous)
{
...
//-----------------------------------------------------------------------------
template hellofem::basis::FiniteElement<float>
hellofem::basis::create_tp_element(element::family, cell::type, int,
    element::lagrange_variant, element::dpc_variant, bool);
template hellofem::basis::FiniteElement<double>
hellofem::basis::create_tp_element(element::family, cell::type, int,
    element::lagrange_variant, element::dpc_variant, bool);
...
hellofem::basis::tp_factors(element::family family, cell::type cell, int degree,
    element::lagrange_variant lvariant,
    element::dpc_variant dvariant, bool discontinuous,
...
//-----------------------------------------------------------------------------
template std::optional<std::vector<std::vector<hellofem::basis::FiniteElement<float>>>>
hellofem::basis::tp_factors(element::family, cell::type, int, element::lagrange_variant,
    element::dpc_variant, bool, const std::vector<int>&);
template std::optional<std::vector<std::vector<hellofem::basis::FiniteElement<double>>>>
hellofem::basis::tp_factors(element::family, cell::type, int, element::lagrange_variant,
    element::dpc_variant, bool, const std::vector<int>&);
//-----------------------------------------------------------------------------
std::optional<std::vector<int>>
hellofem::basis::tp_dof_ordering(element::family family, cell::type cell, int degree,
    element::lagrange_variant, element::dpc_variant, bool)
{
    std::vector<int> dof_ordering;
    std::vector<int> perm;
...
//-----------------------------------------------------------------------------
std::vector<int> hellofem::basis::lex_dof_ordering(element::family family, cell::type cell,
...
//-----------------------------------------------------------------------------
template <std::floating_point T>
FiniteElement<T> hellofem::basis::create_custom_element(
    ...
    int embedded_superdegree, polyset::type poly_type)
{
    ...
    { // scope
        ...
        hellofem::basis::math::orthogonalise(wcoeffs_ortho);
    }
    ...
    return hellofem::basis::FiniteElement<T>(
...
//-----------------------------------------------------------------------------
/// @cond
template FiniteElement<float> hellofem::basis::create_custom_element(
...
template FiniteElement<double> hellofem::basis::create_custom_element(
    cell::type, const std::vector<std::size_t>&,
    ...
    if (this == &e)
        ...
        if (_coeffs.first.size() == e.coefficient_matrix().first.size()
            ...
            and std::ranges::equal(_coeffs.first, e.coefficient_matrix().first,
                [](auto x, auto y) { return std::abs(x - y) < 1.0e-10; })) {
            coeff_equal = true;
        }
...
//-----------------------------------------------------------------------------
std::string hellofem::basis::version()
{
    static const std::string version_str = "0.12.0";
    return version_str;
}
//-----------------------------------------------------------------------------
/// @cond DOXYGEN_SHOULD_SKIP_THIS
template class hellofem::basis::FiniteElement<float>;
template class hellofem::basis::FiniteElement<double>;
/// @endcond
//-----------------------------------------------------------------------------
