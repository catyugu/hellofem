...
using namespace hellofem::basis::indexing;
...
namespace {
        ...
        std::size_t nderiv, md::mdspan<const T, md::dextents<std::size_t, 2>> x)
    {
        ...
        auto quad_idx = [n](std::size_t px, std::size_t py) -> std::size_t { return (2 * n + 1) * px + py; };
        ...
        std::size_t nderiv, md::mdspan<const T, md::dextents<std::size_t, 2>> x)
    {
        ...
        auto hex_idx
            = [n](std::size_t px, std::size_t py, std::size_t pz) -> std::size_t { return (2 * n + 1) * (2 * n + 1) * px + (2 * n + 1) * py + pz; };
        ...
        std::size_t nderiv, md::mdspan<const T, md::dextents<std::size_t, 2>> x)
    {
        ...
        auto pyr_idx
            = [n](std::size_t px, std::size_t py, std::size_t pz) -> std::size_t { return (n + 1) * (n + 1) * px + (n + 1) * py + pz; };
        ...
        std::size_t nderiv, md::mdspan<const T, md::dextents<std::size_t, 2>> x)
    {
        ...
        // Indexing for quadrilateral basis functions
        auto quad_idx = [n](std::size_t px, std::size_t py) -> std::size_t { return (n + 1) * px + py; };
        ...
        std::size_t nderiv, md::mdspan<const T, md::dextents<std::size_t, 2>> x)
    {
        ...
        // Indexing for hexahedral basis functions
        auto prism_idx
            = [n](std::size_t px, std::size_t py, std::size_t pz) -> std::size_t { return (n + 1) * idx(py, px) + pz; };
