...
FiniteElement<T> hellofem::basis::element::create_rtc(cell::type celltype, int degree,
...
//-----------------------------------------------------------------------------
template <std::floating_point T>
FiniteElement<T> hellofem::basis::element::create_nce(cell::type celltype, int degree,
    element::lagrange_variant lvariant,
    bool discontinuous)
{
    if (celltype != cell::type::quadrilateral
...
hellofem::basis::element::create_rtc(cell::type, int, element::lagrange_variant, bool);
template FiniteElement<double>
hellofem::basis::element::create_rtc(cell::type, int, element::lagrange_variant, bool);

template FiniteElement<float>
hellofem::basis::element::create_nce(cell::type, int, element::lagrange_variant, bool);
template FiniteElement<double>
hellofem::basis::element::create_nce(cell::type, int, element::lagrange_variant, bool);
/// @endcond
//-----------------------------------------------------------------------------
