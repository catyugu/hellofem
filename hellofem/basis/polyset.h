...
namespace hellofem::basis::polyset {
    ...
    /// [5] -> (0, 2), [6] -> (3, 0),...
    /// The function hellofem::basis::indexing::idx maps tuples `(p, q, r)` to the
    /// array index.
    ///
    ...
    /// (0, 0), [1] -> (1, 0), [2] -> (0, 1), [3] -> (2, 0), [4] -> (1, 1),
    /// [5] -> (0, 2), [6] -> (3, 0),...
    /// The function hellofem::basis::indexing::idx maps tuples `(p, q, r)` to the array
    /// index.
    /// - The second index is the point, with index `i` corresponding to the
    /// point in row `i` of `x`.
    /// - The third index is the basis function index.
