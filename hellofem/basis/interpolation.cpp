...
hellofem::basis::compute_interpolation_operator(const FiniteElement<T>& element_from,
...
hellofem::basis::compute_interpolation_operator(const FiniteElement<float>&,
    const FiniteElement<float>&);
template std::pair<std::vector<double>, std::array<std::size_t, 2>>
hellofem::basis::compute_interpolation_operator(const FiniteElement<double>&,
